...
import { WorkOutline, Description, Computer, SmartToy, VpnKey, DesignServices, AccountCircle, Menu, ChevronLeft, ViewModule, Logout, Person, Settings, Psychology, AccountTree, CloudUpload, Code } from '@mui/icons-material';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: 'Orchestration', icon: <Psychology />, path: '/orchestration' },
    { text: 'Orchestration Designer', icon: <AccountTree />, path: '/orchestration-designer' },
    { text: 'Deployments', icon: <CloudUpload />, path: '/deployments' },
    { text: 'Code Editor', icon: <Code />, path: '/code-editor' },
